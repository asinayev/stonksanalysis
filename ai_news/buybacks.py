...
ai_reads_search.read_search(google_key, polygon_key, my_cse_id, query='buyback|repurchase share|stock', \
  orTerms='', prompt_template=prompt_template.format(buyback_description), model=model, write_to_dir=write_to_dir)
...
ai_reads_search.read_search(google_key, polygon_key, my_cse_id, query='improves|raises|increases guidance', \
  orTerms='', prompt_template=prompt_template.format(guidance_description), model=model, write_to_dir=write_to_dir)

...
The JSON object must contain the following three keys:

1.  "category": Classify the ETF into ONE of the following specific categories:
    * 'traditional equities'
    * 'speculative equities'
    * 'thematic or geographic equities'
    * 'debt'
    * 'physical commodities'
    * 'currencies'
    * 'cryptocurrencies'
    * 'real estate'
    * 'financial derivatives (like volatility)'
    * 'funds of funds'
    * 'strategies (like following a hedge fund or momentum or events)'
    * 'futures tied to the real world (e.g., carbon credits or shipping routes)'
    * 'other'

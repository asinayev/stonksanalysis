...
# 15: 2022   0.030     -3.2   7.7    254         117      4.511811            29
...
# revert ETFs
# avg_year  avg_trade drawdown drawdown_days days_traded
# 1: 0.02361111 0.01912335     -2.8           317        1348
# year average drawdown total trades days_traded avg_days_held stocks_traded
# 1: 2005   0.009      0.0   0.0      3           3      5.666667             2
# 2: 2006   0.040      0.0   0.1      2           2      4.000000             2
# 3: 2007   0.023      0.0   0.1      3           3      1.666667             3
# 4: 2008   0.008     -1.7   0.8    106          50      6.792453            39
# 5: 2009   0.033     -0.6   2.3     69          40      5.855072            27
# 6: 2010   0.046     -0.2   3.5     76          43      4.578947            18
# 7: 2011   0.004     -2.0   0.5    130          68      5.507692            35
# 8: 2012   0.012     -0.7   0.7     54          41      6.407407            15
# 9: 2013   0.030     -0.1   1.4     48          36      5.062500            15
# 10: 2014   0.045     -0.4   2.9     64          37      5.578125            22
# 11: 2015   0.030     -0.6   4.4    147         101      4.850340            29
# 12: 2016   0.031     -2.8   5.1    164         105      6.347561            30
# 13: 2017   0.042     -0.3   1.6     38          33      6.184211            11
# 14: 2018   0.004     -1.8   0.8    185         112      6.843243            40
# 15: 2019   0.018     -2.0   4.2    234         135      6.012821            30
# 16: 2020   0.014     -1.9   7.1    509         209      6.064833            84
# 17: 2021   0.014     -1.6   4.9    340         173      6.679412            47
# 18: 2022   0.022     -1.8   8.9    406         157      5.790640            73
...
# avg_year  avg_trade drawdown drawdown_days days_traded
# 1: 0.02735294 0.02182994       -4           302        1092
# year average drawdown total trades days_traded avg_days_held stocks_traded
# 1: 2006   0.076      0.0   0.1      1           1      2.000000             1
# 2: 2007   0.028      0.0   0.2      6           6      2.833333             3
# 3: 2008   0.043     -1.1   3.0     70          35      4.828571            31
# 4: 2009   0.018     -0.1   0.3     18          12      4.166667            12
# 5: 2010   0.043     -0.2   3.9     90          48      4.288889            21
# 6: 2011   0.028     -1.0   3.7    133          74      4.060150            49
# 7: 2012   0.007     -0.3   0.2     27          17      4.148148            13
# 8: 2013   0.022     -0.3   1.2     53          29      3.773585            15
# 9: 2014   0.053     -0.3   2.9     55          30      5.472727            26
# 10: 2015   0.026     -0.9   3.0    117          68      4.529915            39
# 11: 2016   0.018     -4.0   3.2    176         107      5.994318            32
# 12: 2017   0.012     -0.8   0.6     50          43      5.800000            13
# 13: 2018   0.006     -2.2   1.3    215         113      5.906977            40
# 14: 2019   0.026     -1.9   4.2    158         106      5.500000            30
# 15: 2020   0.025     -2.9   5.7    228         116      4.868421            79
# 16: 2021   0.018     -1.2   5.1    289         152      5.961938            46
# 17: 2022   0.016     -2.0   5.3    325         135      5.224615            77

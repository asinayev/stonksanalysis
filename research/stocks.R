...
#############
# avg_year  avg_trade drawdown drawdown_days days_traded max_held
# 1: 0.01178571 0.01162571       -1           479        1072       10
# year average drawdown total trades days_traded max_held avg_days_held stocks_traded
# 1: 2009   0.024      0.0   0.2      8           9        3      7.750000             1
# 2: 2010   0.012     -0.1   0.8     65          66        6      4.876923             5
# 3: 2011   0.013     -0.3   1.1     85          86        8      6.717647            13
# 4: 2012   0.010     -0.4   0.9     87          88        7      6.793103            12
# 5: 2013   0.014     -0.4   1.1     78          79        8      7.653846             8
# 6: 2014  -0.002     -0.4  -0.1     70          71        9      6.228571             8
# 7: 2015   0.004     -0.3   0.3     79          80        7      6.569620             8
# 8: 2016   0.003     -1.0   0.2     85          86        6      6.458824            12
# 9: 2017   0.026     -0.1   1.0     39          40        5      5.743590             7
# 10: 2018   0.001     -0.6   0.0     50          51        7      5.440000             9
# 11: 2019   0.007     -0.8   0.6     78          79        7      6.333333            16
# 12: 2020   0.021     -0.8   3.0    141         142        8      6.460993            28

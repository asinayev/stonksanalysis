...
# megacap
# avg_year   avg_trade drawdown drawdown_days days_traded max_held
# 1: 0.006894737 0.007509767       -3           510        2663       51
#    year average drawdown total trades days_traded max_held avg_days_held stocks_traded
# 1: 2004   0.010      0.0   0.1     15          12        8      4.800000             5
# 2: 2005   0.008     -0.4   2.9    352         166       30      5.215909            10
# 3: 2006   0.004     -1.6   1.4    318         132       29      4.194969            10
# 4: 2007   0.006     -0.9   2.6    448         164       35      4.491071            10
# 5: 2008   0.014     -3.0   9.5    699         220       43      5.188841             9
# 6: 2009   0.022     -2.4  11.2    499         180       38      4.717435            11
# 7: 2010   0.003     -1.9   1.6    462         158       44      4.948052            11
# 8: 2011   0.003     -1.0   1.2    438         169       37      4.630137            14
# 9: 2012   0.002     -1.5   0.6    326         150       38      5.092025            12
# 10: 2013   0.004     -0.4   1.0    262         122       25      4.156489            11
# 11: 2014   0.005     -0.5   1.7    355         144       29      4.230986            12
# 12: 2015   0.004     -0.5   1.5    367         148       28      4.564033            12
# 13: 2016   0.003     -0.2   1.2    331         142       25      5.570997            12
# 14: 2017   0.004     -0.1   0.9    215         119       19      4.948837            15
# 15: 2018   0.005     -1.7   2.3    481         164       51      5.729730            11
# 16: 2019   0.004     -1.6   0.9    218          83       30      4.541284            10
# 17: 2020   0.016     -0.9   6.1    388         132       38      4.592784            11
# 18: 2021   0.006     -1.4   2.3    379         153       31      5.029024            11
# 19: 2022   0.008     -1.0   2.9    358         105       41      4.519553            10
...
# bigcap_short
#      avg_year avg_trade drawdown drawdown_days days_traded max_held
# 1: 0.01310526 0.0123839     -2.6           515        1440       42
#     year average drawdown total trades days_traded max_held avg_days_held stocks_traded
# 1: 2004   0.027     -0.1   0.6     24          22        6      6.208333             9
# 2: 2005  -0.004     -1.1  -0.7    161          97       19      6.378882            26
# 3: 2006   0.021     -1.1   3.0    144          94       19      7.402778            31
# 4: 2007   0.016     -1.1   4.1    254         108       40      9.224409            43
# 5: 2008   0.008     -2.6   2.7    343         136       38      7.603499            72
# 6: 2009   0.015     -2.4   7.6    515         152       42      7.159223            79
# 7: 2010   0.003     -0.8   0.3    104          69       15      9.086538            29
# 8: 2011   0.029     -0.4   2.7     92          52       19      6.500000            27
# 9: 2012   0.002     -0.4   0.2    105          46       22      8.600000            32
# 10: 2013   0.019     -0.1   1.2     63          54       17      9.063492            17
# 11: 2014   0.013     -0.3   0.7     56          51       14      7.696429             9
# 12: 2015   0.008     -0.6   0.8    101          62       18      6.970297            26
# 13: 2016   0.013     -0.6   1.7    129          74       19      7.550388            30
# 14: 2017   0.010     -0.1   0.4     37          19       20      6.864865            15
# 15: 2018   0.016     -0.2   0.6     38          29       10      7.526316            19
# 16: 2019  -0.005     -1.3  -0.5    110          75       20      8.736364            25
# 17: 2020   0.015     -1.2   5.2    346         141       29      6.910405            73

...
x = data.table(short_range=c(28), long_range=c(250), max_dip=c(0), crossover_units=c(''), min_dip=c(0),
               buy_trigger=c(-.05), buy_trigger_days_max = c(50), buy_trigger_days_min = c(0),
